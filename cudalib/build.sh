...
gcc -c prediction.cpp -o prediction.o  -I/mnt/6TDisk/caffe_master/caffe/include -I/usr/local/include -I/usr/local/cuda/include  -L/mnt/6TDisk/caffe_master/caffe/build/lib -lcaffe -lhdf5 -L/usr/local/cuda-8.0/lib64 -lcudart -L/usr/lib64 -lglog -lboost_system -lpthread
